...
void Lcd_Port(char a)
{
    (a & 1) ? (LATDbits.LD4 = 1) : (LATDbits.LD4 = 0);
    (a & 2) ? (LATDbits.LD5 = 1) : (LATDbits.LD5 = 0);
    (a & 4) ? (LATDbits.LD6 = 1) : (LATDbits.LD6 = 0);
    (a & 8) ? (LATDbits.LD7 = 1) : (LATDbits.LD7 = 0);
}
...
void Lcd_Init(void)
{
 ...
 TRISDbits.TRISD7 = 0;
    ...
    Lcd_Cmd(0x03);
    _delay((unsigned long)((11)*(48000000/4000.0)));
    Lcd_Cmd(0x03);
    Lcd_Cmd(0x02);
    Lcd_Cmd(0x02);
    Lcd_Cmd(0x08);
